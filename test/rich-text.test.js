...
const CONTENT_FIELDS = [
    ['greenline_create_card', 'description'],
    ['greenline_update_card', 'description'],
    ['greenline_create_task', 'description'],
    ['greenline_update_task', 'description'],
    ['greenline_create_comment', 'text'],
];

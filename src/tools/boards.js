...
const registerBoardsTools = server => {
    ...
    const subResources = [
        {
            name: 'greenline_list_board_columns',
        ...
        {
            name: 'greenline_list_board_labels',
        ...
        {
            name: 'greenline_list_board_members',
        ...
        {
            name: 'greenline_list_board_custom_fields',

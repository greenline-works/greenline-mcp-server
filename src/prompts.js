...
// the data, these bring the GreenLine opinion.
...
const boardReviewText = (board, agingDays) =>
    [
        `Review GreenLine board ${board} for WIP violations and aging cards. Flag what needs attention now.`,
        '',
        'Steps:',
        `1. Call greenline_get_board with board "${board}" (response_format: "json") to confirm the board exists.`,
        '2. Call greenline_list_board_columns for the board (response_format: "json"). Each column is wrapped as',
        ...
        `3. Call greenline_list_cards for the board with count: 100 (response_format: "json"); while has_more is`,
        ...
        '   (cards in work columns, oldest lastActionAt first) with greenline_get_card_metrics for their time in',
...
const checklistGeneratorText = card =>
    [
        `Turn the description of GreenLine card ${card} into a UX Checklist and an AC Checklist, matching`,
        "GreenLine's standard card structure.",
        '',
        'Steps:',
        `1. Call greenline_get_card with id "${card}" and read the description.`,
        ...
        '5. On confirmation, create each checklist with a single greenline_create_checklist call, passing all of',
...
const standupSummaryText = (board, hours) =>
    [
        `Draft a standup update (yesterday / today / blockers) from recent movement on GreenLine board ${board}.`,
        '',
        'Steps:',
        `1. Call greenline_list_cards for the board with count: 100 (response_format: "json"); while has_more is`,
        ...
        `3. Only when a card's story is unclear, call greenline_get_card_history with start set to ${hours} hours`,
        '   ago as an ISO date.',
        '',
        'Output format:',

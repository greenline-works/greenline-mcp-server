...
const boardReviewText = (board, agingDays) =>
    [
        ...
        '3. Call greenline_list_cards for the board with columns set to those columnIds (comma-separated),',
        ...
        '   oldest few candidates per work column (by lastActionAt) with greenline_get_card_metrics. In the',
...
const standupSummaryText = (board, hours) =>
    [
        ...
        '',
        'Steps:',
        `1. Call greenline_list_cards for the board with count: 100 (response_format: "json"). Fetch further`,
